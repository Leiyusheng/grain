...
public class TaskTchSimpleInf {
	...
	public TaskTchSimpleInf() {}
	
	public TaskTchSimpleInf(Task task,int finish_num) {
	...
	public String toString() {
		return "TaskTchSimpleInf [task_logo=" + task_logo + ", task_id=" + task_id + ", task_name=" + task_name
				+ ", level=" + level + ", info=" + info + ", total_num=" + total_num + ", finish_num=" + finish_num
				+ "]";
	}
